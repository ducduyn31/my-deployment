...
* ----------------------------------------------------------------- */
if (typeof window.html5jp == 'undefined') {
  window.html5jp = new Object ();
}
...
* constructor
* ----------------------------------------------------------------- */
  window.html5jp.perspective = function (ctxd, image) {
    // check the arguments
...
* prototypes
* ----------------------------------------------------------------- */
  var proto = window.html5jp.perspective.prototype;
